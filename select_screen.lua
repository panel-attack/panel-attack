...
select_screen = class(function(self)
  self.fallback_when_missing = {nil, nil}
  self.character_select_mode = "1p_vs_yourself"
end)
local select_screen = {}
...
function select_screen.add_client_data(state)
...
function select_screen.refresh_loaded_and_ready_states(state_1, state_2)
...
select_screen_button = class(function(self) end)

-- Draw the character icon at the current button using globals *gross*
function select_screen_button.draw_character(character)
...
function select_screen_button.draw_super_select(player_num)
...
function select_screen_button.draw_cursor(button_height, spacing, player_num, ready)
...
function select_screen_button.draw_player_state(cursor_data, player_number)
...
function select_screen_button.draw_panels(cursor_data, player_number, y_padding)
...
function select_screen_button.draw_levels(cursor_data, player_number, y_padding)
...
function select_screen_button.draw_match_type(cursor_data, player_number, y_padding)
...
function select_screen_button.draw_stage(cursor_data, player_number, x_padding)
...
-- Draws a button for the select screen.
 ...
 function select_screen_button.draw(x, y, w, h, str, halign, valign, no_rect)
