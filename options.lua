...
local function graphics_menu()
  ...
  graphicsMenu = ClickMenu(menu_x, menu_y, nil, themes[config.theme].main_menu_max_height, 1)
...
local function audio_menu(button_idx)
  ...
  local function enter_music_test()
    ret = {
      function()
        ...
        soundTestMenu = ClickMenu(menu_x, menu_y, nil, themes[config.theme].main_menu_max_height, 1)
  ...
  audioMenu = ClickMenu(menu_x, menu_y, nil, themes[config.theme].main_menu_max_height, 1)
...
local function about_menu(button_idx)
  ...
  aboutMenu = ClickMenu(menu_x, menu_y, nil, themes[config.theme].main_menu_max_height, 1)
...
function options.main(button_idx)
  ...
  optionsMenu = ClickMenu(menu_x, menu_y, nil, themes[config.theme].main_menu_max_height, 1)
