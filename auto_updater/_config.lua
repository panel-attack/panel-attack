updater_config = {
    auto_update= true,
    launch_check_interval= 0 * 3600, -- in seconds (default 6h) will check for updates at launch if interval has passed (it will always check for updates ingame in background)
    ...
    server_url= "http://panelattack.com/touch-updates",
