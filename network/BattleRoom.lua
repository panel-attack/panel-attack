...
function BattleRoom:registerPlayerUpdates(messageType)
  ...
  for i = 1, #self.players do
    ...
    if player.isLocal then
      ...
      Signal.connectSignal(player, "selectedCharacterIdChanged", player, update)
      Signal.connectSignal(player, "characterIdChanged", player, update)
      Signal.connectSignal(player, "selectedStageIdChanged", player, update)
      Signal.connectSignal(player, "stageIdChanged", player, update)
      Signal.connectSignal(player, "panelIdChanged", player, update)
      Signal.connectSignal(player, "wantsRankedChanged", player, update)
      Signal.connectSignal(player, "wantsReadyChanged", player, update)
      Signal.connectSignal(player, "difficultyChanged", player, update)
      Signal.connectSignal(player, "startingSpeedChanged", player, update)
      Signal.connectSignal(player, "levelChanged", player, update)
      Signal.connectSignal(player, "colorCountChanged", player, update)
      Signal.connectSignal(player, "inputMethodChanged", player, update)
    else
