...
function select_screen.startNetPlayMatch(self, msg)
  ...
  if GAME.battleRoom.spectating and replay_of_match_so_far then --we joined a match in progress
    ...
    P1:receiveConfirmedInput(uncompressInputsByTable(replay_of_match_so_far.vs.in_buf))
    P2:receiveConfirmedInput(uncompressInputsByTable(replay_of_match_so_far.vs.I))
