...
function select_screen.sendMenuState(self)
  ...
  menuState.character_is_random = (self.players[self.my_player_number].selectedCharacter == self.players[self.my_player_number].character) and nil or self.players[self.my_player_number].selectedCharacter
