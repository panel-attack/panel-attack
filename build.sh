...
zip -r --quiet "${build_dir}panel-attack.love" *.lua *.ttf readme*.txt *.md *.ogg characters computerPlayers default_data engine libraries localization.csv panels rich_presence scenes select_screen stages themes ui -x ".*" \*__MACOSX* \*\.DS_Store
