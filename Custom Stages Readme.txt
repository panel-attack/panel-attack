...
Step by step instructions for adding/modding stages (Windows example):
...
Note: folders starting with "__" will be ignored upon loading. You may choose to remove those "__" to mod/override existing stages.
...
6. Add/update stages.txt file in the assets folder. All stages will be loaded. This file specifies which ones get to be displayed in the select screen.

~~~~ Exhaustive list of a stage folder data! ~~~~

- config.json: this file holds data for the configuration of your stage. The inside should look like that:
...
- background.jpg/png: background for your stage, to be displayed while playing
- thumbnail.jpg/png: thumbnail, to be displayed in the select screen

Note: the following extensions are supported for all sound files: .mp3, .ogg, .it. Optional sounds are in parenthesis
