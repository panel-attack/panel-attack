...
fileUtils.copyFile("rich_presence/discord-rpc_x64.dll","discord-rpc_x64.dll")
local dll_path = love.filesystem.getSaveDirectory() .. "/discord-rpc_x64"
