require("src/developer")
require("src/class")
socket = require("socket")
json = require("src/dkjson")
GAME = require("src/game")
require("src/match")
require("src/BattleRoom")
require("src/util")
require("src/table_util")
require("src/consts")
require("src/queue")
require("src/globals")
require("src/character") -- after globals!
require("src/stage") -- after globals!
require("src/save")
require("src/engine/GarbageQueue")
require("src/engine/telegraph")
require("src/engine")
require("src/AttackEngine")
require("src/localization")
require("src/graphics")
GAME.input = require("src/input")
require("src/network")
require("src/Puzzle")
require("src/PuzzleSet")
require("src/puzzles")
require("src/mainloop")
require("src/sound")
require("src/timezones")
require("src/gen_panels")
require("src/panels")
require("src/theme")
require("src/click_menu")
require("rich_presence.RichPresence")
local logger = require("src/logger")
GAME.scores = require("src/scores")
