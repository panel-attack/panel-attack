...
local process_message = {
  ...
  N=function(s) error("PLEASE DOWNLOAD the latest version of the game from #welcome-getting-started at the TetrisAttackOnline Discord https://discord.panelattack.com") end,
