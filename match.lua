...
function Match.render(self)
  ...
  if self.battleRoom and (GAME.gameIsPaused == false or GAME.renderDuringPause) then
    ...
    if P2 then
      ...
      GraphicsUtil.draw_number(GAME.battleRoom.playerWinCounts[P1.player_number] + (self.battleRoom.modifiedWinCounts[P1.player_number] or 0), themes[config.theme].images.IMG_number_atlas_1P, P1_win_quads, P1.score_x + themes[config.theme].win_Pos[1], P1.score_y + themes[config.theme].win_Pos[2], themes[config.theme].win_Scale, "center")
      -- P2 username
      ...
      GraphicsUtil.draw_number(GAME.battleRoom.playerWinCounts[P2.player_number] + (self.battleRoom.modifiedWinCounts[P2.player_number] or 0), themes[config.theme].images.IMG_number_atlas_2P, P2_win_quads, P2.score_x + themes[config.theme].win_Pos[1], P2.score_y + themes[config.theme].win_Pos[2], themes[config.theme].win_Scale, "center")
    end
