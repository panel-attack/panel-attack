...
function Replay.loadFromFile(replay)
  ...
  if replay.vs then
    ...
    P1 = Stack{which=1, match=GAME.match, is_local=false, level=replayDetails.P1_level, character=replayDetails.P1_char, inputMethod=(replayDetails.P1_inputMethod) or "controller"}
    ...
    if replayDetails.I and string.len(replayDetails.I)> 0 then
      ...
      P2 = Stack{which=2, match=GAME.match, is_local=false, level=replayDetails.P2_level, character=replayDetails.P2_char, inputMethod=(replayDetails.P2_inputMethod) or "controller"}
  ...
  if P1.inputMethod == "touch" then
    P1:receiveConfirmedInput(replayDetails.in_buf)
  else
  ...
  if P2 then
    if P2.inputMethod == "touch" then
      P2:receiveConfirmedInput(replayDetails.I)
    else
