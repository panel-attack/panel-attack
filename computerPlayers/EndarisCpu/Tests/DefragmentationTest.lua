...
function DefragmentationTest.testGetScoredPanelTable1()
    ...
    local panel = Panel(0)
    panel.color = 8
    table.insert(expectedValue, {panel = ActionPanel(panel, 2, 1), score = 23})
    table.insert(expectedValue, {panel = ActionPanel(panel, 3, 1), score = 23})
    table.insert(expectedValue, {panel = ActionPanel(panel, 2, 2), score = 23})
    table.insert(expectedValue, {panel = ActionPanel(panel, 3, 2), score = 23})
    table.insert(expectedValue, {panel = ActionPanel(panel, 4, 1), score = 17})
    table.insert(expectedValue, {panel = ActionPanel(panel, 4, 2), score = 17})
    table.insert(expectedValue, {panel = ActionPanel(panel, 5, 1), score = 9})
    table.insert(expectedValue, {panel = ActionPanel(panel, 6, 1), score = 0})
    table.insert(expectedValue, {panel = ActionPanel(panel, 2, 4), score = 13})
    table.insert(expectedValue, {panel = ActionPanel(panel, 2, 5), score = 26})
    table.insert(expectedValue, {panel = ActionPanel(panel, 3, 5), score = 26})
    table.insert(expectedValue, {panel = ActionPanel(panel, 2, 6), score = 21})
    table.insert(expectedValue, {panel = ActionPanel(panel, 3, 6), score = 21})
    table.insert(expectedValue, {panel = ActionPanel(panel, 4, 6), score = 7})
    table.insert(expectedValue, {panel = ActionPanel(panel, 5, 6), score = 0})
...
function DefragmentationTest.testGetScoredEmptySpaceTable1()
    ...
    local panel = Panel(0)
    panel.color = 0
    table.insert(expectedValue, {panel = ActionPanel(panel, 1, 3), score = 5})
    table.insert(expectedValue, {panel = ActionPanel(panel, 2, 3), score = 5})
    table.insert(expectedValue, {panel = ActionPanel(panel, 3, 3), score = 5})
    table.insert(expectedValue, {panel = ActionPanel(panel, 4, 3), score = 2})
    table.insert(expectedValue, {panel = ActionPanel(panel, 4, 4), score = 1})
    table.insert(expectedValue, {panel = ActionPanel(panel, 4, 5), score = 1})
    table.insert(expectedValue, {panel = ActionPanel(panel, 3, 4), score = 4})
    table.insert(expectedValue, {panel = ActionPanel(panel, 5, 2), score = 1})
    table.insert(expectedValue, {panel = ActionPanel(panel, 5, 3), score = 1})
...
function DefragmentationTest.testGetScoredEmptySpaceTable2()
    ...
    local panel = Panel(0)
    panel.color = 0
    table.insert(expectedValue, {panel = ActionPanel(panel, 5, 6), score = 21})
    table.insert(expectedValue, {panel = ActionPanel(panel, 6, 6), score = 12})
    table.insert(expectedValue, {panel = ActionPanel(panel, 7, 6), score = 8})
    table.insert(expectedValue, {panel = ActionPanel(panel, 8, 6), score = 4})
    --table.insert(expectedValue, {panel = ActionPanel(panel, 9, 6), score = 0})
    --table.insert(expectedValue, {panel = ActionPanel(panel, 10, 6), score = 0})
    table.insert(expectedValue, {panel = ActionPanel(panel, 8, 5), score = 10})
    table.insert(expectedValue, {panel = ActionPanel(panel, 9, 5), score = 3})
    --table.insert(expectedValue, {panel = ActionPanel(panel, 10, 5), score = 0})
    table.insert(expectedValue, {panel = ActionPanel(panel, 9, 4), score = 7})
    table.insert(expectedValue, {panel = ActionPanel(panel, 10, 4), score = 2})
    table.insert(expectedValue, {panel = ActionPanel(panel, 10, 2), score = 3})
