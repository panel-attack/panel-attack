...
local ClickMenu =
  ...
  function(self, xCenter, yMin, width, maxHeight, active_idx)
    ...
    self.menu_controls = {
      up = {
        text = love.graphics.newText(GraphicsUtils.getGlobalFont(), "^"),
        x = menuXPosition,
        y = 10,
        w = 30,
        h = 30,
      ...
      down = {
        text = love.graphics.newText(GraphicsUtils.getGlobalFont(), "v"),
        x = menuXPosition,
        y = 90,
        w = 30,
        h = 30,
...
function ClickMenu:reloadGraphics()
...
function ClickMenu:remove_button(index)
...
function ClickMenu.setHeight(self, maxHeight)
...
function ClickMenu.show_controls(self, forceUpDownShowing)
