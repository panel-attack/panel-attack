...
function Game:initializeLocalPlayer()
  ...
  LocalPlayer:subscribe(config, "inputMethod", function(inputMethod) config.inputMethod = inputMethod end)
  LocalPlayer:subscribe(config, "speed", function(config, speed) config.endless_speed = speed end)
  LocalPlayer:subscribe(config, "difficulty", function(difficulty) config.endless_difficulty = difficulty end)
  LocalPlayer:subscribe(config, "level", function(config, level) config.level = level end)
  LocalPlayer:subscribe(config, "wantsRanked", function(wantsRanked) config.ranked = wantsRanked end)
