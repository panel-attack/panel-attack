...
function GarbageQueueTestingUtils.createMatch(stackHealth, attackFile)
  ...
  local P1 = Stack{which=1, match=match, wantsCanvas=false, is_local=false, panels_dir=config.panels, level=1, levelData = LevelPresets.getModern(1), character=config.character, inputMethod="controller"}
